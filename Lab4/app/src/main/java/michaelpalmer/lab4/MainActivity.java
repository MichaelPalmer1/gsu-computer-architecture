...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        txtOpCode = (TextView) findViewById(R.id.txtOpCode);
    ...
    private void setOpCode() {
        int opCode = 0;
        opCode += (int) (checkBoxOP1.isChecked() ? Math.pow(2, 2) : 0);
        opCode += (int) (checkBoxOP2.isChecked() ? Math.pow(2, 1) : 0);
        opCode += (int) (checkBoxOP3.isChecked() ? Math.pow(2, 0) : 0);

        String[] opCodes = getResources().getStringArray(R.array.op_codes);
        txtOpCode.setText(opCodes[opCode]);
    }
