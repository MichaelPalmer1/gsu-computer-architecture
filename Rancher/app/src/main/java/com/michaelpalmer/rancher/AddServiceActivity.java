...
import com.michaelpalmer.rancher.service.ServiceCommandFragment;
import com.michaelpalmer.rancher.service.ServiceInfoFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Snackbar.make(view, "Creating service...", Snackbar.LENGTH_LONG)
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                ...
                case 1:
                    return new ServiceCommandFragment();
            }
